package com.xtl.automation.sdk.kimi.api;

import com.xtl.automation.sdk.kimi.entity.KimiAiChatResponse;
...
public class KimiApi {
    ...
    public static String kimiAiChat(String model, String systemMessage, String userMessage) {
        String content = "";
        try {
            ...
            String requestBody = String.format("{ \"model\": \"%s\", \"messages\": [ { \"role\": \"system\", \"content\": \"%s\" }, { \"role\": \"user\", \"content\": \"%s\" } ], \"temperature\": %f }", model, systemMessage, userMessage, 0.3);
